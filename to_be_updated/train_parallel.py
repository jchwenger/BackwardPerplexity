...
if __name__=='__main__':
    ...
    trainer = MinGPT_Trainer(model=model,optim=optim,scheduler=scheduler,
                            ...
                            device='cuda:0',parallel=devices, run_config={'model_params':training_params,'train':training_params,'opti':optim_params} )
    ...
    trainer.stepnum =1
    print('Test , model is :', trainer.model)
    trainer.train_steps(steps=steps_to_train,save_every=training_params['save_every'],aggregate=aggregate,
